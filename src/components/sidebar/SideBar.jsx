...
import profileImage from "../Assets/munavir.jpg";
...
function SideBar({ isActive, setActive }) {
  return (
    ...
    >
      <div
        ...
        aria-label="Sidebar"
      >
        <div className="flex flex-col h-full py-4 overflow-y-auto space-y-4 bg-white dark:bg-gray-800 shadow-2xl">
          <div>
            <button
              onClick={() => {
                setActive(!isActive);
            ...
            <div className="flex flex-col items-center p-5 text-gray-900 rounded-lg dark:text-white dark:hover:bg-gray-700 shadow-lg h-48">
              <img
                src={profileImage}
                alt="profile"
  ...
  <li className="border rounded-r-lg relative overflow-hidden bg-customBlue shadow-md">
    <div className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-300 dark:hover:bg-blue-500 group">
